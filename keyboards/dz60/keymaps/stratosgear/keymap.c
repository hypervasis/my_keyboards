...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [L_NAV] = // Super
        LAYOUT_directional(
        // |--------|----1---|----2---|----3---|---4----|---5----|---6----|---7----|---8----|---9----|---0----|-- - ---|-- = ---|-- ~ ---/--BSPC--|
              KC_NO,   KC_F1,   KC_F2,   KC_F3,  KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F21,  KC_F22,  KC_NO,  KC_NO,
        // |--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------||------//--------|
        //
        // |----TAB-----||---Q----|---W----|---E----|---R----|---T----|---Y----|---U----|---I----|---O----|---P----|-- [ ---|-- ] ---|---- \ -----|
    ...
    [L_LIGHT]  = // Right Alt
        ...
        //
        // |----- SHIFT -----|---Z----|---X----|---C----|---V----|---B----|---N----|---M----|---,----|---.----|-- / ---|--SHFT--|-- UP --|--DEL--||
                  KC_NO,       KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,  BL_UP,   BL_TOGG,
        // |-----------------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|-------||
        //
        // |---CTRL---|----WIN---||----ALT---||--------SPACE---------||----FN----|------BCKSPC------||---FN---|--CTRL--|--LEFT--|--DOWN--|-RIGHT--|
              KC_NO,      KC_NO,      KC_NO,           KC_NO,             KC_NO,         KC_NO,       KC_TRNS,  KC_NO,   KC_NO,   BL_DOWN, KC_NO),
        // |---1.25---|---1.25---||---1.25---||--------2.25----------||---1.25---|------2.75--------||---1----|---1----|---1----|---1----|----1---|

    [L_MACROS] = // Right CTRL
        LAYOUT_directional(
        // |--------|----1---|----2---|----3---|---4----|---5----|---6----|---7----|---8----|---9----|---0----|-- - ---|-- = ---|-- ~ ---/--BSPC--|
              KC_NO,   KC_F11,  KC_F12,  KC_F13, KC_F14,  KC_F15,  KC_F16,  KC_F17,  KC_F18,  KC_F19,  KC_F20,  KC_F23,  KC_F24,  QK_RBT , QK_BOOT,
        // |--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------||------//--------|
        //
        // |----TAB-----||---Q----|---W----|---E----|---R----|---T----|---Y----|---U----|---I----|---O----|---P----|-- [ ---|-- ] ---|---- \ -----|
